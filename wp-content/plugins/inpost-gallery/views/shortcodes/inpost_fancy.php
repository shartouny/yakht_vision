...
//***
    ...
    <?php if(!empty($slides) AND is_array($slides)): ?>
        <div style="overflow: hidden;">
            <?php foreach($slides as $gallery_item) : ?><a class="pn_fancybox fancybox_<?php echo $unique_id ?>" rel="gallery_<?php echo $unique_id ?>" href="<?php echo $gallery_item['imgurl'] ?>" title="<?php echo $gallery_item['title'] ?>"><img style="<?php echo $styles_img ?>" src="<?php echo InpostGallery::get_image($gallery_item['imgurl'], $thumb_width . 'x' . $thumb_height) ?>" alt="" /></a><?php endforeach; ?>
        </div>
    <?php endif; ?>
