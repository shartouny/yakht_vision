var PN_APP_SHORTCODES = function() {
    var self = {
        html_buffer: null,
        init: function() {
            if (!jQuery("#pn_shortcodes_html_buffer").length) {
            ...
            //***
            jQuery('body').on('click', ".js_shortcode_checkbox_self_update", function() {
            ...
            //***
            jQuery('body').on('click', ".js_shortcode_radio_self_update", function() {
                jQuery("input[data-shortcode-field=" + jQuery(this).attr('name') + "]").val(jQuery(this).val()).trigger('change');
            });
            //***
            jQuery('body').on('click', '.pn_button_upload2', function()
            {
            ...
            jQuery('body').on('click', '.js_pn_show_help', function() {
...
var INPOSTGALLERY_ADMIN_SLIDES = function() {
    ...
    var self = {
        ...
        init: function() {
            ...
            //*****
            jQuery('body').on('click', '.js_inpost_gallery_add_slide', function(event)
            {
                window.send_to_editor = function(html)
                {
                    self.insert_html_in_buffer(html);
            ...
            jQuery('body').on('click', ".js_inpost_gallery_delete_slide", function() {
            ...
            jQuery('body').on('click', ".js_inpost_gallery_update_slide_title", function() {
