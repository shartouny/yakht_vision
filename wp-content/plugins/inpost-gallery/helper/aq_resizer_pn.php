...
if (!class_exists('Aq_ResizePN')) {
    ...
    class Aq_ResizePN {
        ...
        /**
         * For your custom default usage you may want to initialize an Aq_ResizePN object by yourself and then have own defaults
         */
...
if (!function_exists('aq_resize_pn')) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function aq_resize_pn($url, $width = null, $height = null, $crop = null, $single = true, $upscale = false) {
        $aq_resize = Aq_ResizePN::getInstance();
