...
class __TwigTemplate_0ec855ce60360be528fb5bb55911275d9e9dbfff0cdcb9aabc6527d2c4cd18de extends \WPML\Core\Twig\Template
{
    ...
    {
        // line 1
        $this->loadTemplate("preview.twig", "slot-subform-statics-footer.twig", 1)->display(twig_array_merge($context, ["preview" => $this->getAttribute($this->getAttribute((isset($context["previews"]) ? $context["previews"] : null), "statics", []), "footer", [])]));
        // line 2
        echo "
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "footer", []), "template", []), "slot_type" => "footer"]));
        // line 13
        echo "
\t";
        // line 14
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "footer", []), "template_slug" => $this->getAttribute(        // line 18
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "footer", [])]));
        // line 29
        echo "
</div>";
    }
    ...
    {
        return new Source("", "slot-subform-statics-footer.twig", "/home/yachtvis/public_html/test/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/slot-subform-statics-footer.twig");
    }
}
