...
class __TwigTemplate_536f1f33c19980b14c7313268c0fa280dc68cee95f1454fca23e0732ef04032e extends \WPML\Core\Twig\Template
{
    ...
    {
        // line 1
        $this->loadTemplate("preview.twig", "slot-subform-statics-shortcode_actions.twig", 1)->display(twig_array_merge($context, ["preview" => $this->getAttribute($this->getAttribute((isset($context["previews"]) ? $context["previews"] : null), "statics", []), "shortcode_actions", [])]));
        // line 2
        echo "
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "shortcode_actions", []), "template", []), "slot_type" => "shortcode_actions"]));
        // line 13
        echo "
\t";
        // line 14
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "shortcode_actions", []), "template_slug" => $this->getAttribute(        // line 19
...
(isset($context["settings"]) ? $context["settings"] : null), "statics", []), "shortcode_actions", [])]));
        // line 30
        echo "
</div>";
    }
    ...
    {
        return new Source("", "slot-subform-statics-shortcode_actions.twig", "/home/yachtvis/public_html/test/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/slot-subform-statics-shortcode_actions.twig");
    }
}
