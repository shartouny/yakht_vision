...
/* table-slots.twig */
class __TwigTemplate_fac19576d384a7f6dd05b515d52f75e9c176e6f3d5681fb8f40a07088404345f extends \WPML\Core\Twig\Template
{
...
";
        // line 8
        if (twig_in_filter((isset($context["slug"]) ? $context["slug"] : null), [0 => "footer", 1 => "post_translations"])) {
            // line 9
            echo "    ";
            $context["label_action"] = $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "misc", []), "label_action", []);
        } else {
            // line 11
            echo "    ";
            $context["label_action"] = $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "misc", []), "label_actions", []);
        }
        // line 13
        echo "
<table id=\"";
        // line 14
        echo \WPML\Core\twig_escape_filter($this->env, (isset($context["table_id"]) ? $context["table_id"] : null), "html", null, true);
    ...
    <tr>
        ...
        if ( !(isset($context["is_static"]) ? $context["is_static"] : null)) {
            echo "<th>";
            echo \WPML\Core\twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "misc", []), "label_position", []), "html", null, true);
            echo "</th>";
        }
        // line 19
        echo "        <th";
        ...
        echo ">";
        echo \WPML\Core\twig_escape_filter($this->env, (isset($context["label_action"]) ? $context["label_action"] : null), "html", null, true);
        echo "</th></tr>
    </thead>
    <tbody>
    ";
...
(isset($context["slots"]) ? $context["slots"] : null)]));
    ...
    {
        return new Source("", "table-slots.twig", "/home/yachtvis/public_html/test/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/table-slots.twig");
    }
}
