...
class __TwigTemplate_c8bf6b93d44f443ba5d343e0384636a822cfa8802763a2b28914d9209ed69c43 extends \WPML\Core\Twig\Template
{
...
";
        // line 5
        $this->loadTemplate("preview.twig", "slot-subform-menus.twig", 5)->display(twig_array_merge($context, ["preview" => (isset($context["preview"]) ? $context["preview"] : null)]));
        // line 6
        echo "
...
(isset($context["slot_settings"]) ? $context["slot_settings"] : null), "template", []), "slot_type" => "menus"]));
        // line 24
        echo "
    ";
        // line 25
...
(isset($context["slot_settings"]) ? $context["slot_settings"] : null), "slot_type" => "menus"]));
    ...
    {
        return new Source("", "slot-subform-menus.twig", "/home/yachtvis/public_html/test/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/slot-subform-menus.twig");
    }
}
